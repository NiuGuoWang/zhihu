package com.example.geekmvp.mygeek.utils;
...
import com.example.geekmvp.mygeek.apps.Constants;
import com.example.geekmvp.mygeek.apps.MyApp;
...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) MyApp.app.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
